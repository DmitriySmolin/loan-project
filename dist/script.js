...
/* harmony import */ var _modules_differnece__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/differnece */ "./src/js/modules/differnece.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  new _modules_differnece__WEBPACK_IMPORTED_MODULE_3__["default"](".officerold", ".officernew", ".officer__card-item").init();
  new _modules_form__WEBPACK_IMPORTED_MODULE_4__["default"](".form").init();
});

/***/ }),

/***/ "./src/js/modules/differnece.js":
/*!**************************************!*\
  !*** ./src/js/modules/differnece.js ***!
  \**************************************/
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(btnPlus, items, counter) {
    ...
    value: function maskInit() {
      ...
      function createMask(event) {
        ...
        this.value = matrix.replace(/./g, function (a) {
          ...
          return result; //   return /[_\d]/.test(a) && i < val.length ? val.charAt(i++) : i >= val.length ? '' : a;
        });
      ...
      this.forms.forEach(function (form) {
        form.addEventListener("submit", function (e) {
          ...
          _this.postData(_this.path, formData).then(function (res) {
            ...
            textMessage.textContent = _this.message.succes;
          }).catch(function (err) {
            console.log(err);
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (btn, i) {
        try {
          var blodckedElem = btn.closest(".module__video-item").nextElementSibling;
        ...
        btn.addEventListener("click", function () {
          if (!btn.closest(".module__video-item") || btn.closest(".module__video-item").getAttribute("data-disabled") !== "true") {
            ...
            if (document.querySelector("iframe#frame")) {
              ...
              if (_this.url !== btn.getAttribute("data-url")) {
                _this.url = btn.getAttribute("data-url");
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function prevSlide() {
      for (var i = this.slides.length - 1; i > 0; i -= 1) {
    ...
    key: "activatedAnimation",
    value: function activatedAnimation() {
      var _this3 = this;
    ...
    key: "changeAnimation",
    value: function changeAnimation(selector) {
      var _this4 = this;
